...
const EditGoal = () => {
    ...
    const fetchGoal = async () => {
      try {
        ...
        if (docSnap.exists()) {
         ...
         setCategory(data.category || "Giant Bamboo");
  ...
  <Picker selectedValue={category} onValueChange={(val) => setCategory(val)}>
    ...
    <Picker.Item label="🌳 Timber Bamboo" value="Timber Bamboo" />
      ...
      <Pressable onPress={handleUpdate} style={[styles.button, { backgroundColor: "#2F5D50" }]}>
  <Text style={styles.buttonText}>Update Bamboo Item</Text>
</Pressable>
